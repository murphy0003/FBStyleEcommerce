...
namespace InternProject.Dtos
{
    ...
    public record GetPostResponseDto(Guid PostId , string ItemName , string Description , decimal Price , string ItemStatus , string ItemCondition , Guid SellerId , DateTime CreatedAt , DateTime UpdatedAt , IEnumerable<PostImageDto> Images);
